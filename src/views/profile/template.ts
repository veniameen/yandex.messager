export default `
    <div class="grid profile">
        <div class="profile__sidebar">
            <a class="grid grid-column grid-middle profile__backlink" href="/">
        ...
        <div class="profile__content">
            <div class="grid grid-column profile__container">
                ...
                <div class="profile__fullname">{{name}}</div>
                        ...
                        <div class="profile-form__list">
                            {{#each fields}}
                                <div class="profile-form__field">
                                    ...
                                    <input class="profile-form__text-input" id={{name}} name={{name}} type={{type}} value={{value}} disabled>
                ...
                <div class="profile__action">
                    <ul class="profile__action-list">
                        <li class="profile__action-item">
                            <a class="link" href="/change-profile.html">Изменить данные</a>
                        </li>
                        <li class="profile__action-item">
                            <a class="link" href="/change-password.html">Изменить пароль</a>
                        </li>
                        <li class="profile__action-item">
                            <a class="link link-danger" href="/">Выйти</a>
                        </li>
                    </ul>
                </div>
            </div>
